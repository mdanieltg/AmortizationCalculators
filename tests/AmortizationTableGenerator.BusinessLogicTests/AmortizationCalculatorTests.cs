...
using static AmortizationTableGenerator.BusinessLogic.AmortizationCalculator;
...
public class AmortizationCalculatorTests
{
    ...
    public void GetEMI_Success_WhenInterestIsNotZero()
    {
        ...
        // Act
        var emiA = GetEquatedMonthlyInstallment(infoA.Principal, infoA.Rate, infoA.Terms, infoA.Frequency);
    ...
    public void GetEMI_Success_WhenInterestIsZero()
    {
        ...
        var emiC = GetEquatedMonthlyInstallment(infoC.Principal, 0, infoC.Terms, infoC.Frequency);
